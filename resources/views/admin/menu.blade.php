		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<a href="{{route('index')}}" class=" hvr-bounce-to-right"><i class="fa fa-desktop nav_icon"></i> <span>Order</span><span class="fa arrow"></span></a>
						
					</li>
					<li>
						<a href="{{route('index')}}" class=" hvr-bounce-to-right"><i class="fa fa-desktop nav_icon"></i> <span>Sale</span><span class="fa arrow"></span></a>
						
					</li></li><li>
						<a href="{{route('customer')}}" class=" hvr-bounce-to-right"><i class="fa fa-desktop nav_icon"></i> <span>Customer</span><span class="fa arrow"></span></a>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<li><a href="{{route('cate.index')}}" class=" hvr-bounce-to-right"><i class="fa fa-map-marker nav_icon"></i>List Category</a></li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<li><a href="{{route('cate.create')}}" class=" hvr-bounce-to-right"><i class="fa fa-map-marker nav_icon"></i>Add Category</a></li>
