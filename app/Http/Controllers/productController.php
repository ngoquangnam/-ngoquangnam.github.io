...
class productController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('listproduct',compact('bien','data','data1','data2'));
    }
    ...
    public function create()
    {
        ...
        $data1 = color::select('id','color')->get()->toArray();
        $data2 = size::select('id','size')->get()->toArray();
        return view('addproduct',compact('data','data1','data2'));
    }
    ...
    public function edit($id)
    {
        ...
        $data1 = color::select('id','color')->get()->toArray();
        $data2 = size::select('id','size')->get()->toArray();
        return view('editproduct',compact('data','cate','data1','data2','datacolor','datasize'));
    }
